...
const PieChart = () => {
  useEffect(() => {
    const getChartOptions = () => {
        return {
          series: [40, 30, 20, 10], // Random data for social media usage
          colors: ["#4267B2", "#1DA1F2", "#E1306C", "#FF0000"], // Facebook, Twitter, Instagram, YouTube colors
          chart: {
            height: 420,
            width: "100%",
            type: "pie",
          ...
          labels: ["Facebook", "Twitter", "Instagram", "YouTube"], // Social media platforms
          dataLabels: {
            enabled: true,
            style: {
  ...
  return (
    <div className="h-max w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
