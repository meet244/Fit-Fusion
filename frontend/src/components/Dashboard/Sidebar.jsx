          ...
          <ul className="space-y-2 font-medium">
              ...
              <div
                ...
                className={`${
                  window.location.pathname === "/dashboard/analytics"
                    ? "dark:bg-gray-600"
                    : ""
                } cursor-pointer flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group `}
              >
                <svg
            ...
            <li>
              <div
                ...
                className={`${
                  window.location.pathname === "/dashboard/generation"
                    ? "dark:bg-gray-600"
                    : ""
                } cursor-pointer flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group `}
              >
            ...
            <li>
              <div
                ...
                className={`${
                  window.location.pathname === "/dashboard/contests"
                    ? "dark:bg-gray-600"
                    : ""
                } cursor-pointer flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group `}
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Contests</span>
              </div>
            </li>
            <li>
              <div
